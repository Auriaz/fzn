...
class Animal
{
    ...
    public function getAdoptionAt(): ?\DateTimeInterface
    {
        return $this->adoptionAt;
    }

    public function setAdoptionAt(?\DateTimeInterface $adoptionAt): self
    {
        $this->adoptionAt = $adoptionAt;
